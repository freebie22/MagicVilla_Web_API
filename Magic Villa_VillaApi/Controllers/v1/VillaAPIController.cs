...
namespace Magic_Villa_VillaApi.Controllers.v1
{
    ...
    public class VillaAPIController : ControllerBase
    {
        ...
        public VillaAPIController(ILogging<VillaAPIController> logger, IMapper mapper, IVillaRepository repository)
        {
            _logger = logger;
            _mapper = mapper;
            ...
            int pageSize = 2, int pageNumber = 1)
        {
            ...
            if(occupancy > 0)
            {
                villas = await _repository.GetAllAsync(v => v.Occupancy == occupancy, pageSize: pageSize, pageNumber: pageNumber);
            }
